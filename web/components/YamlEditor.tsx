...
import type { Schema } from "@/lib/data/yamlForm";
...
interface Props {
  ...
  meta: UserFileMeta;
  schema: Schema;
  /** Anchor-id prefix so multiple forms on one page never collide. */
  anchorPrefix: string;
  /** ARIA label for the section nav (e.g. "Profile sections"). */
  navLabel: string;
  onSaved: () => void;
      ...
      <header className="editor-head">
        ...
        <div className="editor-stats">
          ...
          <div className="editor-stat">
            ...
            <span className="editor-stat-val">{meta.exists ? updatedLabel : "—"}</span>
          </div>
        </div>
      </header>
